...
from structured_output_kit.utils import box_line, log_response, final_report, record_extraction, convert_schema
from structured_output_kit.core.types import HostInfo
...
def run_extraction_core(req: ExtractionRequest) -> ExtractionResult:
    ...
    exp_info = [
        "*" * box_width,
        f"{'Extraction 시작'.center(box_width)}",
